  ...
  try {
    ...
    await responder.respond({
      content: [
        ...
        '⚠️ This will delete the game, its characters, NPCs, and creatures. Players will be removed from the game. You have **30 days** to restore it before it is permanently removed. Use `/restore-game` to recover it.',
      ].join('\n'),
      embeds: [],
