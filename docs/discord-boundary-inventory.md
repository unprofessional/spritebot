...
gated modal submission. Every migrated outbound operation must name its timeout, total budget, and
retry policy.
...
| Slash/context commands                                        | `src/commands/*.ts` (all 28 command files; 65 findings)                                                                                                                                                                                                   | Interaction replies, deferrals, edits, follow-ups, and modal acknowledgements                  | Yes                                                   | No callback retries                                                                     | Interaction responder                                                  | Core, character/game, and inventory/RP batches complete; admin/support/subscription and voice remain in Task 6 |
