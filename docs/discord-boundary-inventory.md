...
ephemeral auto-defer policies. Every migrated outbound operation must name its timeout, total
...
| Slash/context commands                                        | `src/commands/*.ts` (all 28 command files; 48 findings)                                                                                                                                                                                                   | Interaction replies, deferrals, edits, follow-ups, and modal acknowledgements                  | Yes                                                   | No callback retries                                                                     | Interaction responder                                                  | Core, character/game, inventory/RP and support batches complete; admin, automation, and voice remain in Task 6 |
