...
selector-launch commands. Every migrated outbound operation must name its timeout, total budget,
and retry policy.
...
| Slash/context commands                                        | `src/commands/*.ts` (all 28 command files; 87 findings)                                                                                                                                                                                                   | Interaction replies, deferrals, edits, follow-ups, and modal acknowledgements                  | Yes                                                   | No callback retries                                                                     | Interaction responder                                                  | Core and character/game mutation batches complete; remaining inventory/RP, admin/support/subscription, and voice batches in Task 6 |
